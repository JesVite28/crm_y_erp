...
class RolePermissionController extends Controller
{
        ...
        return response()->json([
            ...
            "roles" => $roles->map(function ($role) {
                return [
                    ...
                    "permissions" => $role->permissions->map(function ($rol) {
                        $rol ->permission_pluck = $rol->permissions->pluck("name");
                        $rol ->create_at = $rol->created_at->format("Y-m-d h:i A");
                        return $rol;
                    })
                ];
            })
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            ...
            "role" => [
                ...
                "create_at" => $role->created_at->format("Y-m-d h:i A"),
            ]
        ]);
    }
    ...
    public function destroy(string $id)
    {
        ...
        return response()->json([
            "message" => 200,
            "message_text" => "El rol ha sido eliminado"
        ]);
    }
}
